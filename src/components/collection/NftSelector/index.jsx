const NftSelector = ({ selectorTab, setSelectorTab }) => {
  ...
  const default_css =
    'flex-1 rounded-full py-3 sm:py-[12px] sm:text-base sm:font-medium'
    ...
    <div className="text-center bg-white rounded-full font-medium dark:bg-neutral-800">
      <div className="flex justify-evenly">
        ...
        <button
          ...
          className={`${default_css} ${
            selectorTab === 'listing' ? active_css : ''
          }`}
        >
          <p>Listings</p>
        </button>
